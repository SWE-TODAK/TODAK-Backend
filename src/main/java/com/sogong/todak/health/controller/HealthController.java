    ...
    public ResponseEntity<?> recordMetricValue(
        ...
        return ResponseEntity.ok(Map.of(
                ...
                "data", Map.of(
                        ...
                        "metricType", actualMetricType, // 알아낸 타입을 여기에 쏙 넣습니다.
